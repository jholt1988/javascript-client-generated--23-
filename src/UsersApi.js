...
export default class UsersApi {
    ...
    */
     ...
     * @callback module:UsersApi~getAllUsersCallback
     ...
     * data is of type: {@link Array.<module:User>}
     */
    getAllUsers() {
      let postBody = null;
     ...
     * @callback module:UsersApi~getUserCallback
     * @param {String} error Error message, if any.
     ...
     * @callback module:UsersApi~updateUserCallback
     * @param {String} error Error message, if any.
     * @param {module:User} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
